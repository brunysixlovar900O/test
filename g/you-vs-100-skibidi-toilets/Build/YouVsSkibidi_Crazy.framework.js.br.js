    ...
    return (function(unityFramework) {
        ...
        function createWasm() {
            ...
            function receiveInstance(instance, module) {
                ...
                Module["asm"] = exports;
                wasmMemory = Module["asm"]["Zg"];
                updateGlobalBufferAndViews(wasmMemory.buffer);
                wasmTable = Module["asm"]["sh"];
                addOnInit(Module["asm"]["_g"]);
        ...
        function _InitSDK(version, objectName) {
            ...
            script.src = "crazygames-sdk-v2.js";
        ...
        function JS_DeviceMotion_eventHandler(event) {
            ...
            if (JS_Accelerometer_callback != 0)
                ...
                )(accelerometerValue.x, accelerometerValue.y, accelerometerValue.z);
            ...
            if (JS_LinearAccelerationSensor_callback != 0)
                (function(a1, a2, a3) {
                    dynCall_vfff.apply(null, [JS_LinearAccelerationSensor_callback, a1, a2, a3])
                }
                )(linearAccelerationValue.x, linearAccelerationValue.y, linearAccelerationValue.z);
            if (JS_GravitySensor_callback != 0) {
                ...
                )(gravityValue.x, gravityValue.y, gravityValue.z)
            }
            if (JS_Gyroscope_callback != 0) {
                ...
                )(event.rotationRate.alpha * degToRad, event.rotationRate.beta * degToRad, event.rotationRate.gamma * degToRad)
            }
        }
        ...
        function JS_GravitySensor_eventHandler() {
            if (JS_GravitySensor_callback != 0)
                ...
                )(JS_GravitySensor.x * JS_Accelerometer_multiplier, JS_GravitySensor.y * JS_Accelerometer_multiplier, JS_GravitySensor.z * JS_Accelerometer_multiplier)
        }
        ...
        function JS_Gyroscope_eventHandler() {
            if (JS_Gyroscope_callback != 0)
                ...
                )(JS_Gyroscope.x, JS_Gyroscope.y, JS_Gyroscope.z)
        }
        ...
        function JS_OrientationSensor_eventHandler() {
            if (JS_OrientationSensor_callback != 0)
                (function(a1, a2, a3, a4) {
                    dynCall_vffff.apply(null, [JS_OrientationSensor_callback, a1, a2, a3, a4])
                }
                )(JS_OrientationSensor.quaternion[0], JS_OrientationSensor.quaternion[1], JS_OrientationSensor.quaternion[2], JS_OrientationSensor.quaternion[3])
        }
        ...
        function JS_ScreenOrientation_eventHandler() {
            if (JS_ScreenOrientation_callback)
                ...
                )(window.innerWidth, window.innerHeight, screen.orientation ? screen.orientation.angle : window.orientation)
        }
            ...
            channel.playSoundClip = function(soundClip, startTime, startOffset) {
                try {
                    ...
                    this.source.onended = function() {
                        ...
                        if (self.callback) {
                            (function(a1) {
                                dynCall_vi.apply(null, [self.callback, a1])
                            }
                            )(self.userData)
                        }
                    }
        ...
        function _JS_SystemInfo_GetDocumentURL(buffer, bufferSize) {
            if (buffer)
                stringToUTF8('https://crazygames.com', buffer, bufferSize);
        ...
        function _JS_WebRequest_Send(requestId, ptr, length, arg, onresponse, onprogress) {
            ...
            function HandleSuccess(response, body) {
                ...
                if (requestOptions.init.enableStreamingDownload) {
                    ...
                    )(arg, response.status, 0, body.length, 0, kWebRequestOK)
                    ...
                    )(arg, response.status, buffer, body.length, 0, kWebRequestOK)
                } else {
                    (function(a1, a2, a3, a4, a5, a6) {
                        dynCall_viiiiii.apply(null, [onresponse, a1, a2, a3, a4, a5, a6])
                    }
                    )(arg, response.status, 0, 0, 0, kWebRequestOK)
                }
                if (requestOptions.tempBuffer) {
                    _free(requestOptions.tempBuffer)
                }
            ...
            function HandleProgress(e) {
                ...
                if (e.chunk) {
                    ...
                    )(arg, response.status, e.loaded, e.total, buffer, e.chunk.length)
                } else {
                    (function(a1, a2, a3, a4, a5, a6) {
                        dynCall_viiiiii.apply(null, [onprogress, a1, a2, a3, a4, a5, a6])
                    }
                    )(arg, response.status, e.loaded, e.total, 0, 0)
                }
            }
            try {
                if (length > 0) {
        ...
        function _Purchase(code) {
            var codeStr = Pointer_stringify(code);
            buy(codeStr)
        }
        function _PurchaseComplete(id) {
            purchaseComplete(id)
        }
        ...
        function _ShowAccountLinkPromptSDK() {
            window.UnitySDK.ensureLoaded(function() {
                window.CrazyGames.SDK.user.showAccountLinkPrompt(function(error, response) {
                    SendMessage(window.UnitySDK.userObjectName, "JSLibCallback_ShowAccountLinkPrompt", JSON.stringify({
                        error: error,
        ...
        function _ShowAuthPromptSDK() {
            window.UnitySDK.ensureLoaded(function() {
                window.CrazyGames.SDK.user.showAuthPrompt(function(error, user) {
                    SendMessage(window.UnitySDK.userObjectName, "JSLibCallback_ShowAuthPrompt", JSON.stringify({
                        error: error,
                        userStr: JSON.stringify(user)
                    }))
                })
            ...
            function buildExprTree(tokens) {
                while (tokens.length > 1 || typeof tokens[0] != "function") {
                    tokens = function(tokens) {
                        ...
                        if (tokens[i] == ")")
                            throw "Parsing failure, mismatched parentheses in parsing!" + tokens.toString();
        ...
        var asmLibraryArg = {
            "sa": _AddUserScoreSDK,
            "Ua": _CheckLanguage,
            "K": _CopyToClipboardSDK,
            "Gc": _GameplayStartSDK,
            "Fc": _GameplayStopSDK,
            "ee": _GetJSLoadTimeInfo,
            "fe": _GetJSMemoryInfo,
            "_a": _GetUrlParametersSDK,
            "bb": _GetUserSDK,
            "ab": _GetUserTokenSDK,
            "Hc": _HappyTimeSDK,
            "$a": _InitSDK,
            ...
            "Md": _JS_DOM_UnityCanvasSelector,
            "Rd": _JS_Eval_OpenURL,
            "Fd": _JS_FileSystem_Initialize,
            "V": _JS_FileSystem_Sync,
            "ke": _JS_GravitySensor_IsRunning,
            "Bb": _JS_GravitySensor_Start,
            "Ab": _JS_GravitySensor_Stop,
            "he": _JS_GuardAgainstJsExceptions,
            "je": _JS_Gyroscope_IsRunning,
            "zb": _JS_Gyroscope_Start,
            "yb": _JS_Gyroscope_Stop,
            "le": _JS_LinearAccelerationSensor_IsRunning,
            "Db": _JS_LinearAccelerationSensor_Start,
            "Cb": _JS_LinearAccelerationSensor_Stop,
            "Dc": _JS_Log_Dump,
            "Sd": _JS_Log_StackTrace,
            "_d": _JS_MobileKeybard_GetIgnoreBlurEvent,
            "ba": _JS_MobileKeyboard_GetKeyboardStatus,
            "pb": _JS_MobileKeyboard_GetText,
            "Od": _JS_MobileKeyboard_GetTextSelection,
            "xa": _JS_MobileKeyboard_Hide,
            "Pd": _JS_MobileKeyboard_SetCharacterLimit,
            "Qd": _JS_MobileKeyboard_SetText,
            "Nd": _JS_MobileKeyboard_SetTextSelection,
            "qb": _JS_MobileKeyboard_Show,
            "oe": _JS_OrientationSensor_IsRunning,
            ...
            "ge": _JS_ScreenOrientation_DeInit,
            "qe": _JS_ScreenOrientation_Init,
            "U": _JS_ScreenOrientation_Lock,
            "Tg": _JS_Sound_Create_Channel,
            "Sa": _JS_Sound_GetLength,
            "Pg": _JS_Sound_GetLoadState,
            "Ng": _JS_Sound_Init,
            "Ac": _JS_Sound_Load,
            "Og": _JS_Sound_Load_PCM,
            "Ra": _JS_Sound_Play,
            "Ta": _JS_Sound_ReleaseInstance,
            "Mb": _JS_Sound_ResumeIfNeeded,
            "Qg": _JS_Sound_Set3D,
            "Lg": _JS_Sound_SetListenerOrientation,
            "Mg": _JS_Sound_SetListenerPosition,
            "Cc": _JS_Sound_SetLoop,
            "Bc": _JS_Sound_SetLoopPoints,
            "pa": _JS_Sound_SetPaused,
            "Y": _JS_Sound_SetPitch,
            "Sg": _JS_Sound_SetPosition,
            "Rg": _JS_Sound_SetVolume,
            "qa": _JS_Sound_Stop,
            "ca": _JS_SystemInfo_GetCanvasClientSize,
            "zc": _JS_SystemInfo_GetDocumentURL,
            ...
            "Ud": _JS_SystemInfo_GetScreenSize,
            "te": _JS_SystemInfo_HasAstcHdr,
            "ub": _JS_SystemInfo_HasCursorLock,
            "de": _JS_SystemInfo_HasFullscreen,
            "Ba": _JS_SystemInfo_HasWebGL,
            "Ld": _JS_UnityEngineShouldQuit,
            "Ig": _JS_WebRequest_Abort,
            "Fg": _JS_WebRequest_Create,
            "Gg": _JS_WebRequest_GetResponseMetaData,
            "Hg": _JS_WebRequest_GetResponseMetaDataLengths,
            "Qa": _JS_WebRequest_Release,
            "Bg": _JS_WebRequest_Send,
            "Dg": _JS_WebRequest_SetRedirectLimit,
            "Cg": _JS_WebRequest_SetRequestHeader,
            "Eg": _JS_WebRequest_SetTimeout,
            "Z": _OpenNewTab,
            "_": _Purchase,
            "Xa": _PurchaseComplete,
            "aa": _RequestAdSDK,
            "Za": _RequestBannersSDK,
            "$": _RequestInviteUrlSDK,
            "cb": _ShowAccountLinkPromptSDK,
            "db": _ShowAuthPromptSDK,
            "Wa": _ShowFullscreenAd,
            "Va": _ShowRewardedAd,
            "Ya": _SyncFiles,
            ...
            "xd": ___syscall__newselect,
            "Vc": ___syscall_chmod,
            "ze": ___syscall_connect,
            "Wc": ___syscall_faccessat,
            "G": ___syscall_fcntl64,
            "nf": ___syscall_fstat64,
            "Rc": ___syscall_getcwd,
            "Oc": ___syscall_getdents64,
            "gb": ___syscall_ioctl,
            "Ve": ___syscall_lstat64,
            "Qc": ___syscall_mkdir,
            "ef": ___syscall_newfstatat,
            "rc": ___syscall_openat,
            "Ec": ___syscall_readlinkat,
            "pe": ___syscall_recvfrom,
            "Tc": ___syscall_renameat,
            "Pc": ___syscall_rmdir,
            "re": ___syscall_sendto,
            "Nc": ___syscall_socket,
            "mf": ___syscall_stat64,
            "Ug": ___syscall_statfs64,
            "Vg": ___syscall_truncate64,
            "Uc": ___syscall_unlinkat,
            "Sc": ___syscall_utimensat,
            "ac": __dlopen_js,
            "He": __dlsym_js,
            "T": __emscripten_date_now,
            "ob": __emscripten_get_now_is_monotonic,
            "Wg": __emscripten_throw_longjmp,
            "Wd": __gmtime_js,
            "be": __localtime_js,
            "ie": __mktime_js,
            "Jc": __munmap_js,
            ...
            "Gd": _emscripten_set_main_loop_timing,
            ...
            "dg": _glDeleteShader,
            "Zb": _glDeleteSync,
            "cg": _glDeleteTextures,
            "jf": _glDeleteVertexArrays,
            "na": _glDepthFunc,
            "ma": _glDepthMask,
            "bg": _glDetachShader,
            "ag": _glDisable,
            "$f": _glDisableVertexAttribArray,
            "Yf": _glDrawArrays,
            ...
            "ia": _glFramebufferTextureLayer,
            "la": _glFrontFace,
            "Tf": _glGenBuffers,
            "Pf": _glGenFramebuffers,
            "bc": _glGenQueries,
            "Qf": _glGenRenderbuffers,
            "Ee": _glGenSamplers,
            "Sf": _glGenTextures,
            "kf": _glGenVertexArrays,
            "Rf": _glGenerateMipmap,
            "Of": _glGetActiveAttrib,
            "Ma": _glGetActiveUniform,
            "Da": _glGetActiveUniformBlockName,
            "P": _glGetActiveUniformBlockiv,
            "O": _glGetActiveUniformsiv,
            "Nf": _glGetAttribLocation,
            "Xb": _glGetBufferSubData,
            "Mf": _glGetError,
            "Lf": _glGetFramebufferAttachmentParameteriv,
            "We": _glGetIntegeri_v,
            "La": _glGetIntegerv,
            "Je": _glGetInternalformativ,
            "_b": _glGetProgramBinary,
            "Jf": _glGetProgramInfoLog,
            "H": _glGetProgramiv,
            "fc": _glGetQueryObjectuiv,
            "lf": _glGetQueryiv,
            "Wf": _glGetRenderbufferParameteriv,
            "Gf": _glGetShaderInfoLog,
            ...
            "lb": invoke_iiiiiiiii,
            "N": invoke_iiiiiiiiii,
            "eb": invoke_iiiiiiiiiii,
            "id": invoke_iiiiiiiiiji,
            "ld": invoke_iiiijii,
            "dd": invoke_iiji,
            "$c": invoke_iji,
            "pd": invoke_ji,
        ...
        var ___wasm_call_ctors = Module["___wasm_call_ctors"] = function() {
            return (___wasm_call_ctors = Module["___wasm_call_ctors"] = Module["asm"]["_g"]).apply(null, arguments)
        }
        ;
        var _getMetricsInfo = Module["_getMetricsInfo"] = function() {
            return (_getMetricsInfo = Module["_getMetricsInfo"] = Module["asm"]["$g"]).apply(null, arguments)
        }
        ;
        var _SendMessageFloat = Module["_SendMessageFloat"] = function() {
            return (_SendMessageFloat = Module["_SendMessageFloat"] = Module["asm"]["ah"]).apply(null, arguments)
        }
        ;
        var _SendMessageString = Module["_SendMessageString"] = function() {
            return (_SendMessageString = Module["_SendMessageString"] = Module["asm"]["bh"]).apply(null, arguments)
        }
        ;
        var _SendMessage = Module["_SendMessage"] = function() {
            return (_SendMessage = Module["_SendMessage"] = Module["asm"]["ch"]).apply(null, arguments)
        }
        ;
        var _SetFullscreen = Module["_SetFullscreen"] = function() {
            return (_SetFullscreen = Module["_SetFullscreen"] = Module["asm"]["dh"]).apply(null, arguments)
        }
        ;
        var _main = Module["_main"] = function() {
            return (_main = Module["_main"] = Module["asm"]["eh"]).apply(null, arguments)
        }
        ;
        var ___errno_location = Module["___errno_location"] = function() {
            return (___errno_location = Module["___errno_location"] = Module["asm"]["fh"]).apply(null, arguments)
        }
        ;
        ...
        var _ntohs = Module["_ntohs"] = function() {
            return (_ntohs = Module["_ntohs"] = Module["asm"]["hh"]).apply(null, arguments)
        }
        ;
        var _strlen = Module["_strlen"] = function() {
            return (_strlen = Module["_strlen"] = Module["asm"]["ih"]).apply(null, arguments)
        }
        ;
        ...
        var _free = Module["_free"] = function() {
            return (_free = Module["_free"] = Module["asm"]["kh"]).apply(null, arguments)
        }
        ;
        var _emscripten_builtin_memalign = Module["_emscripten_builtin_memalign"] = function() {
            return (_emscripten_builtin_memalign = Module["_emscripten_builtin_memalign"] = Module["asm"]["lh"]).apply(null, arguments)
        }
        ;
        var _setThrew = Module["_setThrew"] = function() {
            return (_setThrew = Module["_setThrew"] = Module["asm"]["mh"]).apply(null, arguments)
        }
        ;
        ...
        var stackRestore = Module["stackRestore"] = function() {
            return (stackRestore = Module["stackRestore"] = Module["asm"]["oh"]).apply(null, arguments)
        }
        ;
        var stackAlloc = Module["stackAlloc"] = function() {
            return (stackAlloc = Module["stackAlloc"] = Module["asm"]["ph"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_ii = Module["dynCall_ii"] = function() {
            return (dynCall_ii = Module["dynCall_ii"] = Module["asm"]["wh"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_viii = Module["dynCall_viii"] = function() {
            return (dynCall_viii = Module["dynCall_viii"] = Module["asm"]["yh"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_iiiii = Module["dynCall_iiiii"] = function() {
            return (dynCall_iiiii = Module["dynCall_iiiii"] = Module["asm"]["Ah"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_viiiiii = Module["dynCall_viiiiii"] = function() {
            return (dynCall_viiiiii = Module["dynCall_viiiiii"] = Module["asm"]["Ch"]).apply(null, arguments)
        }
        ;
        var dynCall_viiiii = Module["dynCall_viiiii"] = function() {
            return (dynCall_viiiii = Module["dynCall_viiiii"] = Module["asm"]["Dh"]).apply(null, arguments)
        }
        ;
        var dynCall_viiii = Module["dynCall_viiii"] = function() {
            return (dynCall_viiii = Module["dynCall_viiii"] = Module["asm"]["Eh"]).apply(null, arguments)
        }
        ;
        var dynCall_iiiiii = Module["dynCall_iiiiii"] = function() {
            return (dynCall_iiiiii = Module["dynCall_iiiiii"] = Module["asm"]["Fh"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_fii = Module["dynCall_fii"] = function() {
            return (dynCall_fii = Module["dynCall_fii"] = Module["asm"]["Hh"]).apply(null, arguments)
        }
        ;
        var dynCall_fi = Module["dynCall_fi"] = function() {
            return (dynCall_fi = Module["dynCall_fi"] = Module["asm"]["Ih"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_i = Module["dynCall_i"] = function() {
            return (dynCall_i = Module["dynCall_i"] = Module["asm"]["Kh"]).apply(null, arguments)
        }
        ;
        var dynCall_iiiiiiii = Module["dynCall_iiiiiiii"] = function() {
            return (dynCall_iiiiiiii = Module["dynCall_iiiiiiii"] = Module["asm"]["Lh"]).apply(null, arguments)
        }
        ;
        var dynCall_iiiijii = Module["dynCall_iiiijii"] = function() {
            return (dynCall_iiiijii = Module["dynCall_iiiijii"] = Module["asm"]["Mh"]).apply(null, arguments)
        }
        ;
        var dynCall_jii = Module["dynCall_jii"] = function() {
            return (dynCall_jii = Module["dynCall_jii"] = Module["asm"]["Nh"]).apply(null, arguments)
        }
        ;
        var dynCall_ji = Module["dynCall_ji"] = function() {
            return (dynCall_ji = Module["dynCall_ji"] = Module["asm"]["Oh"]).apply(null, arguments)
        }
        ;
        var dynCall_iiiiiiiii = Module["dynCall_iiiiiiiii"] = function() {
            return (dynCall_iiiiiiiii = Module["dynCall_iiiiiiiii"] = Module["asm"]["Ph"]).apply(null, arguments)
        }
        ;
        var dynCall_viiiiiiiiii = Module["dynCall_viiiiiiiiii"] = function() {
            return (dynCall_viiiiiiiiii = Module["dynCall_viiiiiiiiii"] = Module["asm"]["Qh"]).apply(null, arguments)
        }
        ;
        var dynCall_viiiiiiii = Module["dynCall_viiiiiiii"] = function() {
            return (dynCall_viiiiiiii = Module["dynCall_viiiiiiii"] = Module["asm"]["Rh"]).apply(null, arguments)
        }
        ;
        var dynCall_viiiiiiiii = Module["dynCall_viiiiiiiii"] = function() {
            return (dynCall_viiiiiiiii = Module["dynCall_viiiiiiiii"] = Module["asm"]["Sh"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_viiffi = Module["dynCall_viiffi"] = function() {
            return (dynCall_viiffi = Module["dynCall_viiffi"] = Module["asm"]["Vh"]).apply(null, arguments)
        }
        ;
        var dynCall_iiiiiiiiiii = Module["dynCall_iiiiiiiiiii"] = function() {
            return (dynCall_iiiiiiiiiii = Module["dynCall_iiiiiiiiiii"] = Module["asm"]["Wh"]).apply(null, arguments)
        }
        ;
        var dynCall_iiiiiiiiii = Module["dynCall_iiiiiiiiii"] = function() {
            return (dynCall_iiiiiiiiii = Module["dynCall_iiiiiiiiii"] = Module["asm"]["Xh"]).apply(null, arguments)
        }
        ;
        var dynCall_viji = Module["dynCall_viji"] = function() {
            return (dynCall_viji = Module["dynCall_viji"] = Module["asm"]["Yh"]).apply(null, arguments)
        }
        ;
        var dynCall_vffff = Module["dynCall_vffff"] = function() {
            return (dynCall_vffff = Module["dynCall_vffff"] = Module["asm"]["Zh"]).apply(null, arguments)
        }
        ;
        var dynCall_fiii = Module["dynCall_fiii"] = function() {
            return (dynCall_fiii = Module["dynCall_fiii"] = Module["asm"]["_h"]).apply(null, arguments)
        }
        ;
        var dynCall_f = Module["dynCall_f"] = function() {
            return (dynCall_f = Module["dynCall_f"] = Module["asm"]["$h"]).apply(null, arguments)
        }
        ;
        var dynCall_vfff = Module["dynCall_vfff"] = function() {
            return (dynCall_vfff = Module["dynCall_vfff"] = Module["asm"]["ai"]).apply(null, arguments)
        }
        ;
        var dynCall_iiifi = Module["dynCall_iiifi"] = function() {
            return (dynCall_iiifi = Module["dynCall_iiifi"] = Module["asm"]["bi"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_iiiidii = Module["dynCall_iiiidii"] = function() {
            return (dynCall_iiiidii = Module["dynCall_iiiidii"] = Module["asm"]["di"]).apply(null, arguments)
        }
        ;
        var dynCall_vidi = Module["dynCall_vidi"] = function() {
            return (dynCall_vidi = Module["dynCall_vidi"] = Module["asm"]["ei"]).apply(null, arguments)
        }
        ;
        var dynCall_viidi = Module["dynCall_viidi"] = function() {
            return (dynCall_viidi = Module["dynCall_viidi"] = Module["asm"]["fi"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_jiii = Module["dynCall_jiii"] = function() {
            return (dynCall_jiii = Module["dynCall_jiii"] = Module["asm"]["ki"]).apply(null, arguments)
        }
        ;
        var dynCall_iiji = Module["dynCall_iiji"] = function() {
            return (dynCall_iiji = Module["dynCall_iiji"] = Module["asm"]["li"]).apply(null, arguments)
        }
        ;
        var dynCall_viifii = Module["dynCall_viifii"] = function() {
            return (dynCall_viifii = Module["dynCall_viifii"] = Module["asm"]["mi"]).apply(null, arguments)
        }
        ;
        var dynCall_viiififiii = Module["dynCall_viiififiii"] = function() {
            return (dynCall_viiififiii = Module["dynCall_viiififiii"] = Module["asm"]["ni"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_vififiii = Module["dynCall_vififiii"] = function() {
            return (dynCall_vififiii = Module["dynCall_vififiii"] = Module["asm"]["pi"]).apply(null, arguments)
        }
        ;
        var dynCall_fiffi = Module["dynCall_fiffi"] = function() {
            return (dynCall_fiffi = Module["dynCall_fiffi"] = Module["asm"]["qi"]).apply(null, arguments)
        }
        ;
        var dynCall_dii = Module["dynCall_dii"] = function() {
            return (dynCall_dii = Module["dynCall_dii"] = Module["asm"]["ri"]).apply(null, arguments)
        }
        ;
        var dynCall_vijiii = Module["dynCall_vijiii"] = function() {
            return (dynCall_vijiii = Module["dynCall_vijiii"] = Module["asm"]["si"]).apply(null, arguments)
        }
        ;
        var dynCall_vjjjiiii = Module["dynCall_vjjjiiii"] = function() {
            return (dynCall_vjjjiiii = Module["dynCall_vjjjiiii"] = Module["asm"]["ti"]).apply(null, arguments)
        }
        ;
        var dynCall_vjiiiii = Module["dynCall_vjiiiii"] = function() {
            return (dynCall_vjiiiii = Module["dynCall_vjiiiii"] = Module["asm"]["ui"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_jiiiii = Module["dynCall_jiiiii"] = function() {
            return (dynCall_jiiiii = Module["dynCall_jiiiii"] = Module["asm"]["wi"]).apply(null, arguments)
        }
        ;
        var dynCall_ddiii = Module["dynCall_ddiii"] = function() {
            return (dynCall_ddiii = Module["dynCall_ddiii"] = Module["asm"]["xi"]).apply(null, arguments)
        }
        ;
        var dynCall_viffi = Module["dynCall_viffi"] = function() {
            return (dynCall_viffi = Module["dynCall_viffi"] = Module["asm"]["yi"]).apply(null, arguments)
        }
        ;
        var dynCall_jiiiiiiiiii = Module["dynCall_jiiiiiiiiii"] = function() {
            return (dynCall_jiiiiiiiiii = Module["dynCall_jiiiiiiiiii"] = Module["asm"]["zi"]).apply(null, arguments)
        }
        ;
